				...
				<section role="main" class="content-body">
					...
					<div class="row">
								...
								<section class="panel">
									<header class="panel-heading">
										...
										<p class="panel-subtitle">
											For add <code>User</code> please fill up all field.
										</p>
									</header>	
                      ...
                      value="other">Other
                        ...
                        <div class="form-group">
                          <select name="position" class="form-control" required="" placeholder="User Position">
                    <option value="3" id="position" >Waiter</option>
                    <option value="4" id="position" >Cashier</option>
                    <option value="5" id="position" >Chef</option>
                          </select>
                        </div>
                        <div class="form-group">
                          <input type="file" name="image" class="form-control" required="" >
									...
									<footer class="panel-footer">
										<input type="submit" name="useradd" class="btn btn-primary" value="Add User">
									</footer>
								</section>
							</form>	
						</div>
