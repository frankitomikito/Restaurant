										...
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group">
													...
													<input type="text" name="table_name" class="form-control" required="" placeholder="eg: TBL-21">
													<label class="control-label">Table Capacity</label>
													<input type="text" name="capacity" class="form-control" required="" placeholder="eg: 2-8">
												</div>
											</div>
										</div>
									</div>
