            ...
            <div class="col-md-12">
              <div class="col mb-3 border" style="background: white;">
                  ...
                  <div class="row">
                      <div class="col-md-6" style="text-align: center;">
                        ...
                        <p class="text-center">Bkash Personal Number:</p>
                      ...
                      <div class="col-md-6">
                        ...
                        <ol>
                          ...
                          <li>Enter: <?php echo $bkashnumber; ?></li>
                          <li>Enter the amount you want to send (With bkash transaction cost)</li>
                          <li>Enter a reference. (eg: 1)</li>
                          <li>Enter your bKash Mobile Menu PIN to confirm the transaction</li>
                        </ol>
                      </div>
                  </div>
              </div>
          	...
          	<form action="manage-insert.php" method="POST">
                ...
                <div class="form-group">
                  <input type="text" name="transaction_id" class="form-control" placeholder="Bkash Transaction Id" required="">
                </div>
