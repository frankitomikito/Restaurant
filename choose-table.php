                  ...
                  <div class="row">
                      ...
                      ?>
                    	<div class="col-lg-3" style="margin-bottom: 5px;">
                    		<nav class="menu2">
                          <input type="checkbox" name="table[]" value="<?php echo $table_id; ?>" class="menu-toggler2" >
                          ...
                          <ul>
                            <?php 
                              ...
                              foreach ($result2 as $r2) {
                                ...
                                ?>
                            <li class="menu-item2">
                              <input type="checkbox" name="chair[]" disabled="">
                            </li>
                                <?php } else{ ?>
                            <li class="menu-item2">
                              <input type="checkbox" name="chair[]" value="<?php echo $r2['id']; ?>">
                            </li>
                                <?php } ?>
                            <?php } ?>
                          </ul>
